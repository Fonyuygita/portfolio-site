...
<div className="imgContainer">
    <Image src="/fonyuygita.png" width={300} height={270}  alt='intro' className='img'/>
</div>
      </div>
...
<Link href="https://drive.google.com/file/d/1UMpNy9_kTF5JJ5X-rj44SU8i9rh07PmY/view?usp=sharing" target="_blank" className='flex flex-center justify-center gap-1 bg-[#d6491d] hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-110'>
