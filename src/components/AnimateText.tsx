...
const AnimateText = ({text, className=""}:TextProps) => {
    return (
        <div className='w-full mx-auto py-3 flex items-center justify-center text-center overflow-hidden my-3'>
            <motion.h1 className={`inline-block w-full text-grey leading-normal font-bold capitalize  text-8xl my-2 ${className}`} variants={quotes} initial="initial" animate="animate">
                {/*get each word here */}
